...
import { ProgressBar, Dropdown, Tabs, Tab } from 'react-bootstrap';
...
function Dashboard() {
    ...
    const salesprediction2Data = {};
    const salesprediction3Data = {};
    const salesprediction4Data = {};
                                    ...
                                    <div>
                                        <div className="row">
                                            <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                                <div className="card">
                                                    <div className="card-body text-center">
                                                        <h5 className="mb-2 text-dark font-weight-normal">Category</h5>
                                            ...
                                            <div className="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                                <div className="card">
                                                    <div className="card-body text-center">
                                                        <h5 className="mb-2 text-dark font-weight-normal">Total Products</h5>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-3 col-sm-4 grid-margin  grid-margin-lg-0">
                                                                ...
                                                                <div className="wrapper pt-5">
                                                                    ...
                                                                    <Line data={totalExpencesData} options={totalExpencesOptions} />
                                                                </div>
                                                            </div>
                                                            <div className="col-lg-9 col-sm-8 grid-margin  grid-margin-lg-0">
                                                                <div className="pl-0 pl-lg-4 ">
                                                                    ...
                                                                    <Bar data={deviceSaleData} options={deviceSaleOptions} />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="col-sm-4 grid-margin stretch-card">
                                                <div className="card card-danger-gradient">
                                                    <div className="card-body mb-4">
                                                        ...
                                                        <Bar data={accountRetensionData} options={accountRetensionOptions} />
                                                    </div>
                                            ...
                                            <div className="col-sm-8  grid-margin stretch-card">
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <Line data={pageViewAnalyticData} options={pageViewAnalyticOptions} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-sm-6 grid-margin grid-margin-lg-0 stretch-card">
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <Bar data={myBalanceData} options={myBalanceOptions} />
                                                    ...
                                                    <div className="card-body">
                                                        <div className="dotted-border p-3 mb-3">
                                                            <div className="row">
                                                                ...
                                                                <div className="col-sm-6">
                                                                    <Line data={salespredictionData} options={saleOptions} id="prediction1" />
                                                                    <h3 className="font-weight-bold mt-3 text-dark">$3258</h3>
                                                                    <p className="text-muted mb-0">350-985 sales</p>
                                                                </div>
                                                                <div className="col-sm-6">
                                                                    <Line data={salesprediction2Data} options={saleOptions} id="prediction2" />
                                                                    <h3 className="font-weight-bold mt-3 text-dark">$3258</h3>
                                                                    <p className="text-muted mb-0">350-985 sales</p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="dotted-border p-3">
                                                            <div className="row">
                                                                ...
                                                                <div className="col-sm-6">
                                                                    <Line data={salesprediction3Data} options={saleOptions} id="prediction3" />
                                                                    <h3 className="font-weight-bold mt-3 text-dark">$3258</h3>
                                                                    <p className="mb-0 text-muted">350-985 sales</p>
                                                                </div>
                                                                <div className="col-sm-6">
                                                                    <Line data={salesprediction4Data} options={saleOptions} id="prediction4" />
